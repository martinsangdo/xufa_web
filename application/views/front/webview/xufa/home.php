            ...
            <div class="row">
                ...
                <div class="col-lg-3 g-mb-50 g-mb-0--lg">
                    ...
                    <div class="u-block-hover g-pos-rel">
                        <figure>
                            <img class="img-fluid w-100 u-block-hover__main--zoom-v1" src="/public/unify_assets/img-temp/400x450/img5.jpg" alt="Image Description">
                        </figure>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <address class="g-bg-no-repeat g-font-size-12 mb-0" style="background-image: url(/public/unify_assets/img/maps/map2.png);">
                        <!-- Location -->
